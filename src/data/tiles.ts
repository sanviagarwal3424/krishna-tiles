...
export const tiles: Tile[] = [
  ...
  },
  {
    ...
    material: 'Vitreous China',
    category: 'sanitaryware',
    image: 'https://images.unsplash.com/photo-1523413651479-597eb2da0ad6?w=1200&q=80',
  ...
  // Featured Johnson Tiles
  {
    id: 'johnson-realfeel-glow',
    name: 'Realfeel Glow',
    size: '800 × 800 mm',
    material: 'Glazed Vitrified Tile',
    category: 'living',
    image: 'https://images.unsplash.com/photo-1615529182904-14819c35db37?w=1200&q=80',
    description: 'Johnson Realfeel Glow — a warm, glossy floor tile with natural glow, perfect for modern living spaces.',
    surface: 'floor',
    styles: ['glossy', 'large-format'],
    brand: 'johnson',
    brandSourceUrl: 'https://www.hrjohnsonindia.com/',
  },
  {
    id: 'johnson-epic-decor',
    name: 'Epic Decor',
    size: '600 × 1200 mm',
    material: 'Double-Charge Vitrified',
    category: 'living',
    image: 'https://images.unsplash.com/photo-1617806118233-18e1de247200?w=1200&q=80',
    description: 'Johnson Epic Decor — premium double-charge with intricate patterns for decorative flooring.',
    surface: 'floor',
    styles: ['marble-look', 'glossy'],
    brand: 'johnson',
    brandSourceUrl: 'https://www.hrjohnsonindia.com/',
  ...
  {
    id: 'johnson-moonstone',
    name: 'Moonstone',
    size: '600 × 1200 mm',
    material: 'Glazed Porcelain',
    category: 'living',
    image: 'https://images.unsplash.com/photo-1608501821300-4f99e58bba77?w=1200&q=80',
    description: 'Johnson Moonstone — elegant grey-toned porcelain with subtle sheen for sophisticated interiors.',
    surface: 'both',
    styles: ['matte', 'stone'],
    brand: 'johnson',
    brandSourceUrl: 'https://www.hrjohnsonindia.com/',
  ...
  {
    id: 'johnson-manuto-green',
    name: 'Manuto Green Yellow',
    size: '800 × 800 mm',
    material: 'Glazed Vitrified Tile',
    category: 'living',
    image: 'https://images.unsplash.com/photo-1615971677499-5467cbab01c0?w=1200&q=80',
    description: 'Johnson Manuto Green Yellow — vibrant mosaic pattern with contemporary styling.',
    surface: 'both',
    styles: ['mosaic', 'glossy', 'large-format'],
    brand: 'johnson',
    brandSourceUrl: 'https://www.hrjohnsonindia.com/',
  },
  {
    id: 'johnson-royal-green',
    name: 'Royal Green',
    size: '600 × 1200 mm',
    material: 'Glazed Vitrified',
    category: 'living',
    image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=1200&q=80',
    description: 'Johnson Royal Green — rich green tone with glossy finish for elegant living spaces.',
    surface: 'both',
    styles: ['glossy', 'marble-look'],
    brand: 'johnson',
    brandSourceUrl: 'https://www.hrjohnsonindia.com/',
  },
  {
    id: 'johnson-bella-rosso',
    name: 'Bella Rosso Dark',
    size: '1500 × 1000 mm',
    material: 'Large Format Porcelain',
    category: 'living',
    image: 'https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=1200&q=80',
    description: 'Johnson Bella Rosso — dramatic deep red large-format tile for statement living rooms.',
    surface: 'both',
    styles: ['marble-look', 'glossy', 'large-format'],
    brand: 'johnson',
    brandSourceUrl: 'https://www.hrjohnsonindia.com/',
  ...
  {
    id: 'johnson-deco-cubes',
    name: 'Deco Cubes White',
    size: '600 × 600 mm',
    material: 'Ceramic',
    category: 'bath',
    image: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=1200&q=80',
    description: 'Johnson Deco Cubes — geometric 3D pattern in white for contemporary bathroom walls.',
    surface: 'wall',
    styles: ['mosaic', 'glossy'],
    brand: 'johnson',
    brandSourceUrl: 'https://www.hrjohnsonindia.com/',
  },
];
